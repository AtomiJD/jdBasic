...
if %ERRORLEVEL%==0 (
    ...
    if defined COPY_DLLS (
        ...
        if exist resources\fonts\JetBrainsMono-Regular.ttf (
            copy /Y resources\fonts\JetBrainsMono-Regular.ttf build\jdbasic_default.ttf >nul 2>&1
        )
